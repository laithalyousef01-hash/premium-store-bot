    ...
    if (
        ...
        if kind == "subscription":
            ...
            try:
                ...
                print("DELIVER SUBSCRIPTION RAW ERROR:", e)
            ...
            try:
                ...
                print("DELIVER GAME RAW ERROR:", e)
    ...
    if (
        ...
        if kind == "subscription":
            ...
            try:
                ...
                print("DELIVER SUBSCRIPTION STRUCTURED ERROR:", e)
                await message.reply_text(TEXTS["en"]["failed_deliver_subscription"])
            ...
            try:
                ...
                print("DELIVER GAME STRUCTURED ERROR:", e)
                await message.reply_text(TEXTS["en"]["failed_deliver_game"])
